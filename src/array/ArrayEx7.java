...
//  `Scanner scanner` : 사용자 입력을 받기 위한 Scanner
//  객체 `String[] productNames` : 상품 이름을 저장할 String 배열
    ...
    public static void main(String[] args) {
       ...
       int[] productPrices = new int[maxProducts];
        ...
        if (menu == 1 ){
            ...
            productNames[productCount] = menuName;
            //상품 가격
            ...
            productCount+= 1;
            try {
                int menuPrice = Integer.parseInt(inputPrice); // 문자열을 정수로 변환
                System.out.println("try" + menuPrice);
                productPrices[productCount -1] = menuPrice;
            } catch (NumberFormatException e) {
                System.out.println("잘못된 형식의 가격입니다. 숫자로만 입력해주세요.");
